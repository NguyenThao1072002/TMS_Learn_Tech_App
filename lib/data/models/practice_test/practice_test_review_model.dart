class PracticeTestReviewModel {
  ...
  factory PracticeTestReviewModel.fromJson(Map<String, dynamic> json) {
    return PracticeTestReviewModel(
      id: json['id'] ?? 0,
...
class ReviewPaginationResponse {
  ...
  final List<PracticeTestReviewModel> content;
  ...
  factory ReviewPaginationResponse.fromJson(Map<String, dynamic> json) {
    return ReviewPaginationResponse(
      ...
      content: json['content'] != null
          ? List<PracticeTestReviewModel>.from(
              json['content'].map((x) => PracticeTestReviewModel.fromJson(x)))
          : [],
